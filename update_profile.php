...
if(isset($_POST['update_profile'])){
   ...
   if(!empty($update_pass) || !empty($new_pass) || !empty($confirm_pass)){
      if($update_pass != $old_pass){
         ...
         $message[] = 'Password sudah diperbaharui';
      }
   }
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="inputBox">
            ...
            <span>Foto Profil Bau :</span>
            <input type="file" name="update_image" accept="image/jpg, image/jpeg, image/png" class="box">
         </div>
         <div class="inputBox">
            <input type="hidden" name="old_pass" value="<?php echo $fetch['password']; ?>">
            <span>Password Lama:</span>
            <input type="password" name="update_pass" placeholder="Masukkan Password Lama" class="box">
            <span>Password Baru :</span>
            <input type="password" name="new_pass" placeholder="Masukkan Password Baru" class="box">
            <span>Konfirmasi Password :</span>
            <input type="password" name="confirm_pass" placeholder="Konfirmasi Password" class="box">
         </div>
      </div>
      <input type="submit" value="Perbaharui" name="update_profile" class="btn">
      <a href="profil.php" class="delete-btn">Kembali</a>
      <a href="index.php" class="delete-btn">Kembali ke Beranda</a>
   </form>
