...
<div class="container-fluid bg-dark  text-light footer mt-5 pt-5 wow fadeIn" data-wow-delay="0.1s">
	<div class="header-main">
		...
		<ul class="menu">
			...
			<li class="menu-item">
			<a href="pengumumanUser.php">Pengumuman</a>
			</li>
			<li class="menu-item menu-item-has-children">
				<a href="#" data-toggle="sub-menu">Laporkan<i class="plus"></i></a>
				<ul class="sub-menu">
					<li class="menu-item"><a href="hilang.php">Laporkan Barang Hilang</a></li>
					<li class="menu-item"><a href="temuan.php">Laporkan Barang Temuan</a></li>
				</ul>
			</li>
			<li class="menu-item menu-item-has-children">
				<a href="temukan.php">Temukan</a>
			</li>
			<li class="menu-item">
